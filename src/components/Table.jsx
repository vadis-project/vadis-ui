...
class Table extends Component {
    ...
    render() {
        ...
        return <table key={'table'} className={Object.keys(sorted_ssoar_docs).length>1?"table table-striped table-hover":"table table-striped"}>
